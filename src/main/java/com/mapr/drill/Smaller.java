...
public class Smaller {
    @FunctionTemplate(name = "drillSmaller", scope = FunctionScope.SIMPLE, nulls = NullHandling.NULL_IF_NULL)
    public static class IntIntSmaller implements DrillSimpleFunc {
        @Param
        Float8Holder in1;
        @Param
        Float8Holder in2;
